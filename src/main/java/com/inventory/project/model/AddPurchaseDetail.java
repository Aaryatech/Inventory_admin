...
public class AddPurchaseDetail {
	...
	public String toString() {
		return "AddPurchaseDetail [purDetailId=" + purDetailId + ", purchaseId=" + purchaseId + ", itemName=" + itemName
				...
				+ ", divisionFactor=" + divisionFactor + ", freightAmt=" + freightAmt + ", insuAmt=" + insuAmt
				+ ", cgstPer=" + cgstPer + ", cgstRs=" + cgstRs + ", sgstPer=" + sgstPer + ", sgstRs=" + sgstRs
				...
				+ ", expiryDate=" + expiryDate + ", replaceQty=" + replaceQty + "]";
	}
