...
<c:url var="allRecordwithDate" value="/allRecordwithDate"></c:url> 
	...
	<div id="main-content">
		...
		<div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>Supplier List
				</h1>
		...
		<div class="box" id="pending">
			<div class="box-title">
				...
				<div class="box-tool">
				<a href="${pageContext.request.contextPath}/addSupplier">Add Supplier</a> <a data-action="collapse" href="#"><i
								...
								<tbody>
									...
									<c:forEach items="${supplierList}" var="supplierList"
													...
													<tr>
														...
														<td><c:out value="${supplierList.suppName}" /></td>
																
														<td><c:out value="${supplierList.gstinNo}" /></td>
																 
												 	 	<td><c:out value="${supplierList.city}" /> </td>
												 	 	
														<td><c:out value="${supplierList.mobile1}" /> </td>
