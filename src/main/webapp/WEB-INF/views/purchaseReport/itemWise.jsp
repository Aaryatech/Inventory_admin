...
<body>
	...
	<c:url var="itemPurchaseReport" value="/itemPurchaseReport"></c:url>
	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Item Wise Report
					</h1>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="billwise">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Item Wise Report
							</h3>
							<div class="box-tool">
						...
						<div class="form-group">
								...
								<div class=" box-content">
									...
									<div class="col-sm-5 col-lg-3 controls">
										<select data-placeholder="Select Supplier" name="items[]"
								...
								<div class=" box-content">
									...
									<div class="col-md-3">
										<input class="form-control" id="book_Date" size="16" value="Item"
											 type="text" name="Item" readonly />
							  ...
							  $.each( data, function(key, itemList) {
								  ...
								  document.getElementById("expExcel").disabled=false;
												...
												var tr = $('<tr></tr>');
											  	...
											  	tr.append($('<td style="text-align:right"></td>').html((itemList.recQty).toFixed(2)));
...
function getPdf()
{
	...
	var valid=0;
		...
		if(valid==0)
		{
	    	window.open('${pageContext.request.contextPath}/purchaseBillReport?url=pdf/purchaseItemWisePdf/'+fromDate+'/'+toDate+'/'+item+'/');
		}
    }
</script>
