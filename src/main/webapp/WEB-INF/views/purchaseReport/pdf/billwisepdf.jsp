		...
		<tbody>
			...
			<c:forEach items="${staticlist}" var="staticlist" varStatus="count">
												<tr>
													...
													<td><c:out value="${staticlist.invoiceNo}" /></td> 
													<td width="100"><c:out value="${staticlist.invDate}" /></td> 
													<td width="100"><c:out value="${staticlist.suppName}" /></td>  
													...
													<td style="text-align:right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value = "${staticlist.billAmt}"/>
													  </td> 
													 
														<c:set var="total"  value="${total+staticlist.billAmt }"/>
