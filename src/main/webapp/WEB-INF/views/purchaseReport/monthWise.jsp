...
<body>
	...
	<c:url var="monthPurchaseReport" value="/monthPurchaseReport"></c:url>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="billwise">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Month Wise Report
							</h3>
							<div class="box-tool">
...
function getPdf()
{
	...
	var valid=0;
		...
		if(valid==0)
		{
	    	window.open('${pageContext.request.contextPath}/purchaseBillReport?url=pdf/purchaseMonthWisePdf/'+fromDate+'/'+toDate+'/'+supplier+'/');
		}
    }
</script>
