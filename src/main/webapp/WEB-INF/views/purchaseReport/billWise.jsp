...
<body>
	...
	<c:url var="billWisePurchaseReport" value="/billWisePurchaseReport"></c:url>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="billwise">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Bill Wise Report
							</h3>
							<div class="box-tool">
	...
	<script type="text/javascript"
		...
		function searchbillwise() {
			...
			$.getJSON('${billWisePurchaseReport}',
...
function getPdf()
{
	...
	var valid=0;
		...
		if(valid==0)
		{
	    	window.open('${pageContext.request.contextPath}/purchaseBillReport?url=pdf/purchaseBillWisePdf/'+fromDate+'/'+toDate+'/'+supplier+'/');
		}
    }
</script>
