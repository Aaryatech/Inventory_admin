...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<body> 
<c:url var="addItemInPurchaseBillEdit" value="/addItemInPurchaseBillEdit"></c:url>
<c:url var="editPurchaseItemListInEditPurchaseBill" value="/editPurchaseItemListInEditPurchaseBill"></c:url>
<c:url var="updatePurchaseHeaderInEditBill" value="/updatePurchaseHeaderInEditBill"></c:url>
<c:url var="deleteItemInEditPurchaseList" value="/deleteItemInEditPurchaseList"></c:url>
<c:url var="checkIsSupplierSameStateInEditPurchaseBill" value="/checkIsSupplierSameStateInEditPurchaseBill"></c:url>
			...
			<div class=" box-content">
				...
				<div class="box">
					<form onsubmit="return confirm('Do you really want to submit the form?');" id="validation-form" class="form-horizontal"
						action="${pageContext.request.contextPath}/insertEditPurchaseBill" method="post">
						...
						<div class="box-content">
							...
							<div class="col-md-1"></div>
							 <div class="col-md-2" >Vehicle No.</div>
									<div class="col-md-3">
										 <input type="text" name="vehicleNo" id="vehicleNo" class="form-control" value="${purchaseHeader.vehicleNo}" required>
									</div>
						...
						<div class="col-md-2" >Invoice no.</div>
									<div class="col-md-3">
										 <input type="text" name="invoiceNo" id="invoiceNo" class="form-control" value="${purchaseHeader.invoiceNo}" required>
									</div>
							<div class="col-md-1"></div>
							<div class="col-md-2" >Invoice no. Date</div>
									<div class="col-md-3">
										 <input type="text" name="invoiceDate"   onblur="cdDate()"   id="invoiceDate" value="${purchaseHeader.invDate}" class="form-control date-picker" required>
									</div>
							...
							<div class="col-md-2" >Advance</div>
									<div class="col-md-3">
									 <c:choose>
									 	<c:when test="${purchaseHeader.isPaid==1}">
									 	<c:set var="paid" value="No"></c:set>
									 	</c:when>
									 	<c:otherwise>
									 	<c:set var="paid" value="Yes"></c:set>
									 	</c:otherwise>
									 </c:choose>
										 <select name="isPaid" id="isPaid" onchange="disabledDate()" class="form-control" tabindex="-1" >
										 <option value="${purchaseHeader.isPaid}" selected>${paid}</option>
						...
						<div class="col-md-2" >Days For Date1</div>
									<div class="col-md-3">
										 <input type="text"  name="days1" onchange="cdDate()" id="days1" class="form-control" required disabled>
									</div>
							<div class="col-md-1"></div>
							<div class="col-md-2" >CD Date1</div>
									<div class="col-md-3">
										 <input type="text" name="cdDate1" id="cdDate1" class="form-control"  value="${purchaseHeader.cdDate1}" readonly>
									</div>
						...
						<div class="col-md-2" >Days For Date2</div>
									<div class="col-md-3">
										 <input type="text" name="days2" onchange="cdDate()" id="days2" class="form-control" required disabled>
									</div>
							<div class="col-md-1"></div>
							<div class="col-md-2" >CD Date2</div>
									<div class="col-md-3">
										 <input type="text" name="cdDate2" id="cdDate2" class="form-control" value="${purchaseHeader.cdDate2}" readonly>
									</div>
						...
						<div class="col-md-2" >Days For Date3</div>
									<div class="col-md-3">
										 <input type="text" name="days3" onchange="cdDate()" id="days3" class="form-control" required disabled>
									</div>
							<div class="col-md-1"></div>
							<div class="col-md-2" >CD Date3</div>
									<div class="col-md-3">
										 <input type="text" name="cdDate3" id="cdDate3" class="form-control" value="${purchaseHeader.cdDate3}" readonly>
									</div>
						...
						<div class="col-md-2" >Days For Date4</div>
									<div class="col-md-3">
										 <input type="text" name="days4" onchange="cdDate()" id="days4" class="form-control" required disabled>
									</div>
							<div class="col-md-1"></div>
							<div class="col-md-2" >CD Date4</div>
									<div class="col-md-3">
										 <input type="text" name="cdDate4" id="cdDate4" class="form-control" value="${purchaseHeader.cdDate4}" readonly>
									</div>
					 ...
					 <br>
						...
						<div class=" box-content">
							<div class="row">
								<div style="overflow:scroll;height:100%;width:100%;overflow:auto">
									<table width="100%" border="0"class="table table-bordered table-striped fill-head "
										...
										<tbody> 
										<c:forEach items="${purchaseDetailList}"
												var="purchaseDetailList" varStatus="count">
												...
												<tr>
													...
													<td><c:out value="${purchaseDetailList.recQty}" />  </td>	
													<td><c:out value="${purchaseDetailList.rate}" />  </td>	
													<td><c:out value="${purchaseDetailList.value}" />  </td>	
													<td><c:out value="${purchaseDetailList.discPer}" />  </td>	
													<td><c:out value="${purchaseDetailList.discAmt}" />  </td>	
													<td><c:out value="${purchaseDetailList.discOnBill}" />  </td>	
													<td><c:out value="${purchaseDetailList.insuAmt}" />  </td>	
													<td><c:out value="${purchaseDetailList.freightAmt}" />  </td>	
													<td><c:out value="${purchaseDetailList.taxableAmt}" />  </td>	
													<td><c:out value="${purchaseDetailList.igstPer}" />  </td>	
													<td><c:out value="${purchaseDetailList.cgstRs+purchaseDetailList.sgstRs+purchaseDetailList.igstRs}" />  </td>	
													<td><c:out value="${purchaseDetailList.cessPer}" />  </td>	
													<td><c:out value="${purchaseDetailList.cessRs}" />  </td>	
												 <td><c:out value="${purchaseDetailList.otherExtra}" />  </td>	
												 <td><c:out value="${purchaseDetailList.total}" />  </td>	
												 <td><input style="text-align:right; width:100px" onchange="changeRate(${count.index})" type="text" name="wholesaleRate${count.index}" id="wholesaleRate${count.index}"
									value="${purchaseDetailList.wholesaleRate}" class="form-control" pattern="[+-]?([0-9]*[.])?[0-9]+" required></td>
									
									<td><input style="text-align:right; width:100px" onchange="changeRate(${count.index})" type="text" name="retailRate${count.index}" id="retailRate${count.index}"
									value="${purchaseDetailList.retailRate}" class="form-control" pattern="[+-]?([0-9]*[.])?[0-9]+" required></td>
							...
							<div class="box-content"> 
									<div class="col-md-2">value <i class="fa fa-inr" style="font-size:13px"></i></div>
										<div class="col-md-2">
											<input style="text-align:right; width:150px" type="text" name="basicValue" id="basicValue" value="${purchaseHeader.basicValue}" class="form-control"
										 readonly>
										</div>
									<div class="col-md-2">Freight Amt <i class="fa fa-inr" style="font-size:13px"></i></div>
										<div class="col-md-2">
											<input style="text-align:right; width:150px" type="text" onchange="updatePurchaseHeader();" value="${purchaseHeader.freightAmt}" name="freightAmt" id="freightAmt" class="form-control"
										value="0" pattern="[+-]?([0-9]*[.])?[0-9]+" required>
										</div>
									<div class="col-md-2">CGST <i class="fa fa-inr" style="font-size:13px"></i></div>
										<div class="col-md-2">
											<input style="text-align:right; width:150px" type="text" name="cgst" value="${purchaseHeader.cgst}"  id="cgst" class="form-control"
										 readonly>
										</div>
							...
							<div class="box-content">
									<div class="col-md-2">Particular Disc Total <i class="fa fa-inr" style="font-size:13px"></i></div>
										<div class="col-md-2">
											<input style="text-align:right; width:150px" type="text" name="discAmt2"  value="${purchaseHeader.discAmt2}"  id="discAmt2" class="form-control"
										 readonly>
										</div>
									<div class="col-md-2">Insu Amt <i class="fa fa-inr" style="font-size:13px"></i></div>
										<div class="col-md-2">
											<input style="text-align:right; width:150px" type="text" onchange="updatePurchaseHeader();" value="${purchaseHeader.insuranceAmt}"  name="insuranceAmt" id="insuranceAmt" class="form-control"
										value="0" pattern="[+-]?([0-9]*[.])?[0-9]+" required>
										</div>
									<div class="col-md-2">SGST <i class="fa fa-inr" style="font-size:13px"></i></div>
									<div class="col-md-2">
										<input style="text-align:right; width:150px" type="text" name="sgst" id="sgst" value="${purchaseHeader.sgst}"  class="form-control"
									 readonly>
									</div>
						...
						<div class="box-content"> 
						 	...
						 	<div class="col-md-2">Per Disc %</div>
							  <div class="col-md-1">
								<input style="text-align:right; width:50px" type="text" onchange="updatePurchaseHeader();" value="${purchaseHeader.discPer}"  name="discPerOnBill" id="discPerOnBill"
									value="0" class="form-control" pattern="[+-]?([0-9]*[.])?[0-9]+" required>
									
									 </div>  
											<div class="col-md-1"> 
									<input style="text-align:right; width:60px" type="text" name="discAmt" value="${purchaseHeader.discAmt}"  id="discAmt"
									 class="form-control"
									readonly>
							 ...
							 <div class="col-md-2">Other3(Extra) <i class="fa fa-inr" style="font-size:13px"></i></div>
									<div class="col-md-2">
										<input style="text-align:right; width:150px" type="text" name="extraCharges"  value="${purchaseHeader.otherExtra}"  id="extraCharges" onchange="updatePurchaseHeader();" class="form-control"
									value="0" pattern="[+-]?([0-9]*[.])?[0-9]+" required>
									</div>
									
									<div class="col-md-2">IGST <i class="fa fa-inr" style="font-size:13px"></i></div>
									<div class="col-md-2">
										<input style="text-align:right; width:150px" type="text" name="igst" value="${purchaseHeader.igst}"  id="igst" class="form-control"
									 readonly>
									</div>
							 </div><br>
						  <div class="box-content">
									...
									<div class="col-md-2">Cess <i class="fa fa-inr" style="font-size:13px"></i></div>
										<div class="col-md-2">
											<input style="text-align:right; width:150px" type="text" value="${purchaseHeader.cess}"  name="cess" id="cess" class="form-control"
										readonly>
										</div>
							...
							<div class="box-content">
									...
									<div class="col-md-2">Bill Total <i class="fa fa-inr" style="font-size:13px"></i></div>
										<div class="col-md-2">
											<input style="text-align:right; width:150px" type="text" value="${purchaseHeader.billAmt}"  name="billAmount" id="billAmount" class="form-control"
										 readonly>
										</div>
							...
							<div class="box-content">
									...
									<div class="col-md-2">Round Off <i class="fa fa-inr" style="font-size:13px"></i></div>
										<div class="col-md-2">
											<input style="text-align:right; width:150px" type="text" name="roundOff" value="${purchaseHeader.roundOff}" id="roundOff" class="form-control"
										 readonly>
										</div>
	 ...
	 function isSameState()
		{
		 ...
		 var suppId = $("#suppId").val();
			$
			.getJSON(
					'${checkIsSupplierSameStateInEditPurchaseBill}',
	 ...
	 function edit(key)
	{
		...
		$
		.getJSON(
				'${editPurchaseItemListInEditPurchaseBill}',
	 ...
	 function updatePurchaseHeader()
		{
			...
			$
			.getJSON(
					'${updatePurchaseHeaderInEditBill}',
