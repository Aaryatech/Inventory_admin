	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Invoice Detail
					</h1>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Invoice Detail List
							</h3>
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/bills">Back to List</a> <a data-action="collapse" href="#"><i
									...
									<thead>
										<tr>
											<th width="45" style="width: 18px">Sr.No.</th>
														...
														<th width="100" align="left">Batch</th>
