	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Sale Report(Item & HsnCodewise)
					</h1>
				...
				<div class="col-md-12">
					<div class="box">
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/searchItemwiseSale" class="form-horizontal"
	                         ...
	                         <div class="form-group">
								...
								<div class="box">
									<div class="box-title">
										<h3>
											<i class="fa fa-table"></i>Sale Item List
										</h3>
										<div class="box-tool">
									...
									<div class="table-wrap" >
										...
										<table id="table1" class="table table-bordered table-striped fill-head">
											<thead>
												...
												<tbody>
													   <c:forEach items="${billDetailList}" var="billDetails" varStatus="count">
														<tr>
											...
											<td align="left"><c:out
														value="${billDetails.itemHsncd}" /></td>
...
function genPdf()
{
	...
	window.open('${pageContext.request.contextPath}/pdf?url=/showSaleByItemPdf/'+from_date+'/'+to_date);
    }
}
</script>
<script type="text/javascript">
