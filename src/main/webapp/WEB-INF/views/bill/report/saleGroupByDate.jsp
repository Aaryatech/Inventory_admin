	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Sale Report(Group By Date)
					</h1>
				...
				<div class="col-md-12">
					<div class="box">
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/searchGroupByDateSale" class="form-horizontal"
...
function genPdf()
{
	...
	window.open('${pageContext.request.contextPath}/pdf?url=/showSaleGroupByDatePdf/'+from_date+'/'+to_date);
    }
}
